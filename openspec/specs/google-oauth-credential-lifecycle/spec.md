# google-oauth-credential-lifecycle Specification

## Purpose
Renewable, locally stored Google OAuth 2.0 credential lifecycle with separate normal event-only and QA calendar-management stores, loopback bootstrap, audited QA-only legacy import, and secret redaction.
## Requirements
